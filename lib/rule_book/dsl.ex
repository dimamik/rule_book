defmodule RuleBook.DSL do
  @moduledoc """
  DSL for defining rules with `defrule`.
  ...
  defmacro __using__(_opts) do
    quote do
      import RuleBook.DSL, only: [defrule: 2]
      Module.register_attribute(__MODULE__, :__rulebook_rules__, accumulate: true)
      @before_compile RuleBook.DSL
    end
  end

  @doc "Define a rule with patterns and an action."
